...
const years_provider_1 = require("../providers/years.provider");
class YearService {
    ...
    constructor(dataSourceInstance) {
        ...
        this.yearsProvider = new years_provider_1.YearsProvider(this.dataSourceInstance); // Pass dataSourceInstance
    }
    async initialize() {
