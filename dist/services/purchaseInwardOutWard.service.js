...
exports.PurchaseParcelStatusService = void 0;
const inwardOutward_provider_1 = require("../providers/inwardOutward.provider"); // This provider now handles the SP
const purchasePipeLine_provider_1 = require("../providers/purchasePipeLine.provider");
class PurchaseParcelStatusService {
    constructor(dataSourceInstance) {
        this.dataSourceInstance = dataSourceInstance;
        this.inwardOutWardProvider = new inwardOutward_provider_1.InWardOutWardProvider(this.dataSourceInstance);
        this.purchasePileLineProvider = new purchasePipeLine_provider_1.PurchasePileLine(this.dataSourceInstance);
    }
    async initialize() {
    ...
    async GetEntrybyId(conum, fdat, tdat, accountId, purTrnId) {
    ...
    async InsetEntry(data) {
        return this.purchasePileLineProvider.create(data);
    }
    async UpdateEntry(PurTrnId, data) {
        return this.purchasePileLineProvider.update(PurTrnId, data);
    }
}
exports.PurchaseParcelStatusService = PurchaseParcelStatusService;
// //src/services/PurchaseInwardOutWard.service.ts
